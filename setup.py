...
description = "Price Optimisation for multiple products which have demand correlation."
url = "https://github.com/kenleeaws/test-ci-python"
email = "kenleeaws@gmail.com"
author = "Ken Lee"
...
def get_version():
    version_file = os.path.join(current_dir, "priceopt", "__init__.py")
